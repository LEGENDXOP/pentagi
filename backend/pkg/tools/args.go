...
type SearchInMemoryAction struct {
	...
	Message   string `json:"message" jsonschema:"required,title=User-Facing Message" jsonschema_description:"A concise summary of the query or the information retrieval process to be presented to the user, in English. This message should guide the user towards their goal in a clear and approachable manner."`
}
...
type SearchGuideAction struct {
	...
	Message  string `json:"message" jsonschema:"required,title=User-Facing Guide Search Message" jsonschema_description:"A concise summary of your query and the type of guide needed, to be presented to the user in English. This message should guide the user toward their goal in a clear and approachable manner."`
}
...
type SearchAnswerAction struct {
	...
	Message  string `json:"message" jsonschema:"required,title=User-Facing Answer Search Message" jsonschema_description:"A concise summary of your query and the type of answer needed, to be presented to the user in English. This message should guide the user toward their goal in a clear and approachable manner."`
}
...
type BrowserNavigateAction struct {
	...
	Message   string `json:"message" jsonschema:"required,title=Navigation message" jsonschema_description:"Not so long message explaining what page you want to visit and why, to send to the user in English"`
}
...
type BrowserClickAction struct {
	...
	Message  string `json:"message" jsonschema:"required,title=Click message" jsonschema_description:"Not so long message explaining what element you want to click and why, to send to the user in English"`
}
...
type BrowserFillAction struct {
	...
	Message  string `json:"message" jsonschema:"required,title=Fill message" jsonschema_description:"Not so long message explaining what field you want to fill and why, to send to the user in English"`
}
...
type BrowserScreenshotAction struct {
	...
	Message  string `json:"message" jsonschema:"required,title=Screenshot message" jsonschema_description:"Not so long message explaining why you want to take a screenshot, to send to the user in English"`
}
...
type BrowserEvaluateAction struct {
	...
	Message    string `json:"message" jsonschema:"required,title=Evaluate message" jsonschema_description:"Not so long message explaining what JavaScript you want to run and why, to send to the user in English"`
}
